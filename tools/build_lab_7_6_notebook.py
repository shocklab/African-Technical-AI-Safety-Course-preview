...
M("### What to look at",
  ...
  "",
  "**Question.** Two or three sentences. Does the critique engage with the principle it was",
  "given, or is it disapproval that would fit any prompt? Does the revision fix what the",
  "critique identified? Say which part of Phase 1 you think fails first at this scale.",
  "",
  "*Your answer:*")
...
C("MAFAND = ('https://raw.githubusercontent.com/masakhane-io/lafand-mt/'",
  ...
  "    if lo <= 0.5:",
  "        print('Indistinguishable from chance: the interval above contains 0.5. This model')",
  "        print(f'cannot read {LANG} well enough to judge anything in it, so any agreement')",
  "        print(f'number you produced in {LANG} would be uninterpretable.')",
  "    elif lo < 0.6:",
  "        print(f'Above chance, but only just, and on {len(scores)} sentences. The interval')",
  "        print('clears 0.5 without reaching a level that could carry a judging experiment.')",
  "        print(f'Read a difference measured in {LANG} from this model as a property of the')",
  "        print('instrument rather than of the language.')",
  "    else:",
